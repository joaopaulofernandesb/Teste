...
<body>
    <div class="container">
        ...
        <p class="lead">Digite vimeo token de acesso, nome e descrição, em seguida, arraste o seu arquivo de vídeo para a área pontilhada abaixo para fazer o upload para sua conta vimeo.</p>
        ...
        <div class="row">
          <div class="col-md-8">
            <div class="form-group">
                ...
                <div class="help">Token de acesso aqui: <a href="https://developer.vimeo.com/apps" target="_blank">https://developer.vimeo.com/apps</a></div>
            </div>
            <div class="form-group">
                <input type="text" name="name" id="videoName" class="form-control" placeholder="Nome do vídeo" value=""></input>
            </div>
            <div class="form-group">
                <input type="text" name="description" id="videoDescription" class="form-control" placeholder="Descrição do vídeo" value=""></input>
            </div>
            <div class="checkbox">
                <label>
                    <input type="checkbox" id="upgrade_to_1080" name="upgrade_to_1080"> Atualize para 1080 </input>
                </label>
            </div>
            <div class="checkbox">
                <label>
                    <input type="checkbox" id="make_private" name="make_private"> Tornar privado </input>
                </label>
            </div>
          </div>
          <div class="col-md-4">
            <div id="drop_zone">Solte os arquivos aqui</div>
            <br/>
